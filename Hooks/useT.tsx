...
an obstacle visible to the light of heaven.`,
    ...
    congrats_text: `
    By successfully completing the game's "light-dark" track, you became a certified Initiate*. We hope you had a great time.
    Soon you will have the opportunity to try the new sequel that is being prepared, as well as other surprises.
    `,
    congrats_continue: `Play again`,
    congrats_hint: `* someone who  initiated into a religious teaching or ceremony accessible to a few chosen only`,
  },
  el: {
    menu_play: "Παίξε",
...
`,
    ...
    congrats_text: `Ολοκληρώνοντας με επιτυχία την πίστα «φως-σκοτάδι» του παιχνιδιού, είσαι πλέον και με τη «βούλα», ένας ΜΥΣΤΗΣ*. Ελπίζουμε να πέρασες καλά. Σύντομα θα έχεις τη δυνατότητα να δοκιμάσεις και την καινούργια πίστα που ετοιμάζεται, αλλά και άλλες εκπλήξεις.`,
    congrats_continue: `Παίξε πάλι`,
    congrats_hint: `* αυτός που μυήθηκε σε θρησκευτική διδασκαλία ή τελετή προσιτή σε λίγους`,
  },
};
